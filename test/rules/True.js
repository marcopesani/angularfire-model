...
describe('$firebaseModelValidator when the validation rule is set to "True",', function () {
    ...
    it('should validate a key set to "true"', function () {
        var key = 'testKey';
        var type = 'True';
        var object = {};
    ...
    it('should not validate a key set to "false"', function () {
        var key = 'testKey';
        var type = 'True';
        var object = {};
        ...
        if (message[key]) {
            expect(message[key][0]).toBe('This value should be true');
        }
    });
});